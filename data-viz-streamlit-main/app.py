...
with st.container():
    ...
    st.write(
        ...
        - Inspiration : 
            - What regional gap exists in listing prices? What US communities are highly rated by tourists?
            - Are there any correlations between rental prices and demand?
            - Can the free-text section of the reviews be used to determine any common patterns? What aspects of renting are people’s favorites, and what aspects do they detest?What aspects of renting are people’s favorites, and what aspects do they detest?
            - What different sorts of housing markets are there in the United States? Do they differ based on the location?
        """
    )
